-module(gateway_gatt_char_p2p_status).
-include("gateway_gatt.hrl").
-include("pb/gateway_gatt_char_p2p_status_pb.hrl").
...
uuid(_) ->
    ?UUID_GATEWAY_GATT_CHAR_P2P_STATUS.
...
init(Path, _) ->
    Descriptors =
        [
         {gatt_descriptor_cud, 0, ["P2P Status"]},
...
read_value(State=#state{}, _) ->
    Msg = #gateway_p2p_status_v1_pb{status=gateway_config:p2p_status()},
    Value = gateway_gatt_char_p2p_status_pb:encode_msg(Msg),
